...
*   **Base de Datos**: MySQL 
*   **Autenticacion**: Laravel Sanctum (Autenticacion SPA basada en Cookies / Tokens)
*   **Seguridad**: Throttle (Proteccion de rutas), Request Validators, Proteccion CSRF
...
Abre tu terminal y clona el repositorio del backend en tu máquina:
```bash
